...
v_polar_to_cartesian_pommier(float *const R__ real,
                             ...
                             const int count)
{
    Profiler profiler("RubberBandShifter::VectorOpsComplex::v_polar_to_cartesian_pommier");
    int idx = 0, tidx = 0;
    int i = 0;
...
v_polar_interleaved_to_cartesian_inplace_pommier(float *const R__ srcdst,
                                                 const int count)
{
    Profiler profiler("RubberBandShifter::VectorOpsComplex::v_polar_interleaved_to_cartesian_inplace_pommier");
    int i;
    int idx = 0, tidx = 0;
...
v_polar_to_cartesian_interleaved_pommier(float *const R__ dst,
                                         ...
                                         const int count)
{
    Profiler profiler("RubberBandShifter::VectorOpsComplex::v_polar_to_cartesian_interleaved_pommier");
    int i;
    int idx = 0, tidx = 0;
