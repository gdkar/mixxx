...
_PS_CONST_TYPE(min_norm_pos, int, 0x00800000U);
_PS_CONST_TYPE(mant_mask, int, 0x7f800000U);
_PS_CONST_TYPE(inv_mant_mask, int, ~0x7f800000U);

_PS_CONST_TYPE(sign_mask, int, 0x80000000U);
_PS_CONST_TYPE(inv_sign_mask, int, ~0x80000000U);
