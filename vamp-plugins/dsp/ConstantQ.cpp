...
static inline bool push_precalculated(int uk, int fftlength,
...
static inline double squaredModule(const double & xx, const double & yy) {
    return xx*xx + yy*yy;
}
//----------------------------------------------------------------------------
...
//        std::cerr << "using precalculated kernel" << std::endl;
	...
	hammingWindowRe[u] = 0,hammingWindowIm[u] = 0;
