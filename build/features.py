...
class ModPlug(Feature):
    ...
    def sources(self, build):
        depends.Qt.uic(build)('preferences/dlgprefmodplugdlg.ui')
        return ['sources/soundsourcemodplug.cpp', 'preferences/dlgprefmodplug.cpp']
...
class FFMPEG(Feature):
    ...
    def configure(self, build, conf):
        ...
        if build.platform_is_linux or build.platform_is_osx \
            ...
            elif conf.CheckForPKG('libavresample', '0.0.3'):
