...
class Qt(Dependence):
    ...
    def enabled_modules(build):
        ...
        if qt5:
            qt_modules.extend(['QtWidgets', 'QtConcurrent', 'QtQml', 'QtQuick', 'QtMultimedia'])
        return qt_modules
...
class MixxxCore(Feature):
    ...
    def sources(self, build):
        sources = ["mixxxkeyboard.cpp",
                   ...
                   "dialogs/dlgprefautodj.cpp",
                   "dialogs/dlgprefkey.cpp",
                   "dialogs/dlgprefreplaygain.cpp",
                   "dialogs/dlgprefnovinyl.cpp",
                   "dialogs/dlgabout.cpp",
                   "dialogs/dlgprefeq.cpp",
                   "dialogs/dlgprefeffects.cpp",
                   "dialogs/dlgprefcrossfader.cpp",
                   "dialogs/dlgtagfetcher.cpp",
                   "dialogs/dlgtrackinfo.cpp",
                   "dialogs/dlganalysis.cpp",
                   "dialogs/dlgautodj.cpp",
                   "dialogs/dlghidden.cpp",
                   ...
                   "engine/filter/enginefilter.cpp",
                   "engine/filter/enginefilterbiquad1.cpp",
                   "engine/filter/enginefiltermoogladder4.cpp",
                   "engine/filter/enginefilterbessel4.cpp",
                   "engine/filter/enginefilterbessel8.cpp",
                   "engine/filter/enginefilterbutterworth4.cpp",
                   "engine/filter/enginefilterbutterworth8.cpp",
                   "engine/filter/enginefilterlinkwitzriley4.cpp",
                   "engine/filter/enginefilterlinkwitzriley8.cpp",
        ...
        ui_files = [
            ...
            'dialogs/dlgaboutdlg.ui',
            'dialogs/dlganalysis.ui',
            'dialogs/dlgautodj.ui',
            'dialogs/dlgcoverartfullsize.ui',
            'dialogs/dlgdevelopertoolsdlg.ui',
            'dialogs/dlghidden.ui',
            'dialogs/dlgmissing.ui',
            'dialogs/dlgprefbeatsdlg.ui',
            'dialogs/dlgprefcontrolsdlg.ui',
            'dialogs/dlgprefwaveformdlg.ui',
            'dialogs/dlgprefautodjdlg.ui',
            'dialogs/dlgprefcrossfaderdlg.ui',
            'dialogs/dlgprefkeydlg.ui',
            'dialogs/dlgprefeqdlg.ui',
            'dialogs/dlgprefeffectsdlg.ui',
            'dialogs/dlgpreferencesdlg.ui',
            'dialogs/dlgprefnovinyldlg.ui',
            'dialogs/dlgpreflibrarydlg.ui',
            'dialogs/dlgprefrecorddlg.ui',
            'dialogs/dlgprefreplaygaindlg.ui',
            'dialogs/dlgprefsounddlg.ui',
            'dialogs/dlgprefsounditem.ui',
            'dialogs/dlgprefvinyldlg.ui',
            'dialogs/dlgrecording.ui',
            'dialogs/dlgtagfetcher.ui',
            'dialogs/dlgtrackinfo.ui',
        ] + SCons.Glob('**/*.ui')
