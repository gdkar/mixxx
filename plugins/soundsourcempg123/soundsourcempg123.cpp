...
SINT SoundSourceMpg123::seekSampleFrame(SINT frameIndex) {return mpg123_seek ( m_h, frameIndex, SEEK_SET );}
SINT SoundSourceMpg123::readSampleFrames( SINT numberOfFrames, CSAMPLE* sampleBuffer){
...
QString SoundSourceProviderMpg123::getName() const {return "mpg123: MPEG Audio Layer 1/2/3 Decoder";}
