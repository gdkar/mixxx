...
class ControllerPreset {
  public:
    ...
    inline void setForumLink(const QString forumlink) {m_forumlink = forumlink;}
    inline QString forumlink() const {return m_forumlink;}
    inline void setWikiLink(const QString wikilink) {m_wikilink = wikilink;}
    inline QString wikilink() const {return m_wikilink;}
    inline void setSchemaVersion(const QString schemaVersion) {m_schemaVersion = schemaVersion;}
    inline QString schemaVersion() const {return m_schemaVersion;}
    inline void setMixxxVersion(const QString mixxxVersion) {m_mixxxVersion = mixxxVersion;}
    inline QString mixxxVersion() const {return m_mixxxVersion;}
    inline void addProductMatch(QHash<QString,QString> match) {m_productMatches.append(match);}
