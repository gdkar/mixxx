...
class ControlPickerMenu : public QMenu {
  ...
  public:
    ...
    QList<ConfigKey> controlsAvailable() const;
  ...
  private:
    ...
    void addControl(QString group, QString control, QString title,QString helpText, QMenu* pMenu, bool addReset=false);
    ...
    void addDeckAndSamplerControl(QString control, QString title,QString helpText, QMenu* pMenu,bool addReset=false);
    void addDeckAndPreviewDeckControl(QString control, QString title,QString helpText, QMenu* pMenu,bool addReset=false);
    void addDeckAndSamplerAndPreviewDeckControl(QString control, QString title,QString helpText, QMenu* pMenu,bool addReset=false);
    void addDeckControl(QString control, QString title, QString helpText,QMenu* pMenu, bool addReset=false);
    void addSamplerControl(QString control, QString title, QString helpText,QMenu* pMenu, bool addReset=false);
    void addPreviewDeckControl(QString control, QString title, QString helpText,QMenu* pMenu, bool addReset=false);
    void addMicrophoneAndAuxControl(QString control, QString title,
                                    ...
                                    bool addReset=false);
    void addPrefixedControl(QString group, QString control, QString title,QString menuDescription, QString descriptionPrefix,QMenu* pMenu, bool addReset=false);
