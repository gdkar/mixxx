...
class ControllerMappingTableModel : public QAbstractTableModel, public ControllerPresetVisitor {
    Q_OBJECT
  public:
    ...
    void visit(ControllerPreset* pPreset);
    ...
    // need a delegate.
    virtual QAbstractItemDelegate* delegateForColumn(int column,QWidget* pParent) = 0;
