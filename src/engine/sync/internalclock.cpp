...
InternalClock::InternalClock(const char* pGroup, SyncableListener* pEngineSync, QObject*pParent)
    ...
    m_pClockBpm.reset(new ControlLinPotmeter(ConfigKey(m_group, "bpm"),1, 200, 1, 0.1, true));
...
double InternalClock::getBaseBpm() const {return m_dOldBpm;}
void InternalClock::setMasterBaseBpm(double /*bpm*/) {}
double InternalClock::getBpm() const {return m_pClockBpm->get();}
