...
class EngineFilterPanSingle {
  public:
    ...
    virtual void process(const CSAMPLE* pIn, CSAMPLE* pOutput, CSAMPLE_GAIN leftDelayFrames) {
        CSAMPLE_GAIN delayLeftSourceFrame;
        CSAMPLE_GAIN delayRightSourceFrame;
        ...
        CSAMPLE_GAIN timeBetweenFullSamplesLeft = fmodf(delayLeftSourceFrame, 1);
        CSAMPLE_GAIN timeBetweenFullSamplesRight = fmodf(delayRightSourceFrame, 1);
