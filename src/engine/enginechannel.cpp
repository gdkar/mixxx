...
//        , m_orientation("orientation",EngineChannel::LEFT,this)
        {
    ...
    connect(m_pOrientationLeft, SIGNAL(valueChanged(double)),
            this, SLOT(onOrientationLeft(double)), Qt::DirectConnection);
    ...
    connect(m_pOrientationRight, SIGNAL(valueChanged(double)),
            this, SLOT(onOrientationRight(double)), Qt::DirectConnection);
    ...
    connect(m_pOrientationCenter, SIGNAL(valueChanged(double)),
            this, SLOT(onOrientationCenter(double)), Qt::DirectConnection);
...
void EngineChannel::onOrientationLeft(double v) {if (v > 0) {setOrientation(LEFT);}}
void EngineChannel::onOrientationRight(double v) {if (v > 0) {setOrientation(RIGHT);}}
void EngineChannel::onOrientationCenter(double v) {if (v > 0) {setOrientation(CENTER);}}
void EngineChannel::setOrientation(EngineChannel::ChannelOrientation o){m_pOrientation->setValue(o);}
EngineChannel::ChannelOrientation EngineChannel::getOrientation() const {return m_pOrientation.value();}
