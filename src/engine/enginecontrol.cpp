...
EngineControl::EngineControl(QString group,UserSettingsPointer _config)
        : EngineControl(nullptr, group, _config)
{ }
EngineControl::EngineControl(QObject *pParent, QString group,UserSettingsPointer _config)
        : QObject(pParent),
          m_group(group),
          m_pConfig(_config)
{
