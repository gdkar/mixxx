...
EngineMicrophone::EngineMicrophone(const ChannelHandleAndGroup& handle_group,
    ...
    m_pInputConfigured->connectValueChangeRequest(this, SLOT(slotInputConfiguredChangeRequest(double)),Qt::DirectConnection);
    ControlDoublePrivate::insertAlias(ConfigKey(getGroup(), "enabled"),ConfigKey(getGroup(), "input_configured"));
