...
int EngineFilterBessel4Low::setFrequencyCornersForIntDelay(double desiredCorner1Ratio, int maxDelay) {
    ...
    auto kDelayFactor1 = 0.336440447;
    // Factor, required to hit the end of the quadratic curve
    auto kDelayFactor2 = 1.1044845;
...
EngineFilterBessel4Band::EngineFilterBessel4Band(int sampleRate,double freqCorner1,double freqCorner2)
{
