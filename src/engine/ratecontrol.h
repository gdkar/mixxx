...
class RateControl : public EngineControl {
    Q_OBJECT
public:
    RateControl(QString group, ConfigObject<ConfigValue>* _config, QObject *pParent=0);
    virtual ~RateControl();
  ...
  public slots:
    void onReverseRollActivate(double);
    void onControlRatePermDown(double);
    void onControlRatePermDownSmall(double);
    void onControlRatePermUp(double);
    void onControlRatePermUpSmall(double);
    void onControlRateTempDown(double);
    void onControlRateTempDownSmall(double);
    void onControlRateTempUp(double);
    void onControlRateTempUpSmall(double);
    void onControlFastForward(double);
    void onControlFastBack(double);
