...
void EngineFilterBiquad1HighShelving::setFrequencyCorners(int sampleRate,double centerFreq,double Q,double dBgain) {
...
void EngineFilterBiquad1Low::setFrequencyCorners(int sampleRate,double centerFreq,double Q) {
