...
EngineVuMeter::EngineVuMeter(const QString &group, QObject *pParent)
  ...
  ,m_ctrlPeakIndicator(ConfigKey(group,"PeakIndicator"),0.,1.)
  ,m_pSampleRate("[Master]","samplerate",this){
