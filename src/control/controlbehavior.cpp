...
void ControlNumericBehavior::setParameter(double dParam,
...
void ControlAudioTaperPotBehavior::setParameter(double dParam,
                                                           ControlDoublePrivate* pControl) {
    pControl->set(parameterToValue(dParam), NULL);
}
...
void ControlPushButtonBehavior::setParameter(double dParam, ControlDoublePrivate* pControl) {
    bool pressed = true;
    if (dParam == 0) {
        pressed = false;
    }
