...
void ControlPushButtonBehavior::setValueFromParameter(
    ...
    // Other controller like the VMS4 are using NOTE_ON
    // And NOTE_OFF and a velocity value like a piano keyboard
    bool pressed = true;
    if (dParam == 0) {
        // NOTE_ON + 0 should be interpreted a released according to
