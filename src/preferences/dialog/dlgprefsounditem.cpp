...
void DlgPrefSoundItem::refreshDevices(const QList<SoundDevice*> &devices) {
    ...
    auto newIndex = deviceComboBox->findData(oldDev);
    if (newIndex != -1) {
