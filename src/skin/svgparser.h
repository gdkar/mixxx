...
class SvgParser {
  public:
    ...
    virtual ~SvgParser();
    QDomNode parseSvgTree(const QDomNode& svgSkinNode,const QString& sourcePath) const;
  ...
  private:
    ...
    QScriptValue evaluateTemplateExpression(const QString& expression,int lineNumber) const;
