...
class SkinContext {
  public:
    ...
    int selectInt(const QDomNode& node, const QString& nodeName, bool* pOk=nullptr) const;
    ...
    bool selectAttributeBool(const QDomElement& element,const QString& attributeName,bool defaultValue) const;
    QString selectAttributeString(const QDomElement& element,const QString& attributeName,QString defaultValue) const;
