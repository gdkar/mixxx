...
#include "analysis/analyserrg.h"
#include "analysis/analyserbeats.h"
#include "analysis/analyserkey.h"
...
bool AnalyserQueue::doAnalysis(TrackPointer tio, Mixxx::AudioSourcePointer pAudioSource) {
    ...
    do {
        ...
        const SINT framesRead =
                pAudioSource->readSampleFramesStereo(kAnalysisFramesPerBlock,&m_sampleBuffer);
