...
/* static */ QString PlayerManager::groupForSampler(int i)
{
  return QString{"Sampler%1"}.arg(i+1);
}
/* static */ QString PlayerManager::groupForDeck(int i)
{
  return QString{"Channel%1"}.arg(i+1);
}
/* static */ QString PlayerManager::groupForPreviewDeck(int i)
{
  return QString{"PreviewDeck%1"}.arg(i+1);
}
unsigned int PlayerManager::numberOfDecks()const
{
  return numDecks();
}
unsigned int PlayerManager::numberOfSamplers()const
{
  return numSamplers();
}
unsigned int PlayerManager::numberOfPreviewDecks()const
{
