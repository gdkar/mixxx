...
BrowseFeature::BrowseFeature(QObject* parent,
    ...
    auto devices_link = new TreeItem(
    ...
    for(auto quickLinkPath: m_quickLinkList) {
        ...
        m_pQuickLinkItem->appendChild(new TreeItem(name, quickLinkPath, this, m_pQuickLinkItem));
    }
    // initialize the model
    m_childModel.setRootItem(rootItem);
}

BrowseFeature::~BrowseFeature() = default;
...
void BrowseFeature::bindWidget(WLibrary* libraryWidget,KeyboardEventFilter* keyboard)
{
    Q_UNUSED(keyboard);
