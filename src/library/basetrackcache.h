...
class BaseTrackCache : public QObject {
  ...
  public:
    ...
    virtual QString columnNameForFieldIndex(int index) const;
    virtual QString columnSortForFieldIndex(int index) const;
    virtual int fieldIndex(ColumnCache::Column column) const;
  ...
  private:
    ...
    std::atomic<bool> m_bIndexBuilt;
    std::atomic<bool> m_bIsCaching;
    QHash<int, QVector<QVariant> > m_trackInfo;
    TrackDAO& m_trackDAO;
    QSqlDatabase m_database;
    std::unique_ptr<SearchQueryParser> m_pQueryParser;
