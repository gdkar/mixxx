...
class TrackModel {
  public:
    ...
    virtual int addTracks(const QModelIndex& /*index*/, const QList<QString>& /*locations*/) {return 0;}
    virtual void moveTrack(const QModelIndex& /*sourceIndex*/, const QModelIndex& /*destIndex*/) { }
    virtual bool isLocked() { return false; }
    virtual QAbstractItemDelegate* delegateForColumn(const int /*i*/, QObject* /*pParent*/) { return nullptr;}
    ...
    virtual bool isColumnSortable(int /*column*/) { return true; }
