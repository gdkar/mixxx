...
class EffectSlot : public QObject {
  ...
  signals:
    ...
    void updated();
  private:
    QString debugString() const { return QString("EffectSlot(%1)").arg(m_group);}
    const unsigned int m_iChainNumber;
    const unsigned int m_iEffectNumber;
    const QString m_group;
    EffectPointer m_pEffect;
    ControlObject* m_pControlLoaded = nullptr;
    ControlPushButton* m_pControlEnabled = nullptr;
    ControlObject* m_pControlNumParameters = nullptr;
    ControlObject* m_pControlNumParameterSlots = nullptr;
    ControlObject* m_pControlNumButtonParameters = nullptr;
    ControlObject* m_pControlNumButtonParameterSlots = nullptr;
    ControlObject* m_pControlNextEffect = nullptr;
    ControlObject* m_pControlPrevEffect = nullptr;
    ControlObject* m_pControlEffectSelector = nullptr;
    ControlObject* m_pControlClear = nullptr;
