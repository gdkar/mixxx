...
void DlgAnalysis::onSendToAutoDJ() {
    // append to auto DJ
    m_pAnalysisLibraryTableView->onSendToAutoDJ();
}

void DlgAnalysis::onSendToAutoDJTop() {
    m_pAnalysisLibraryTableView->onSendToAutoDJTop();
}
