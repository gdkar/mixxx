...
class WOverview : public WWidget {
  ...
  private:
    ...
    QSharedPointer<ControlObjectSlave> m_endOfTrackControl;
    double m_endOfTrack;
     QSharedPointer<ControlObjectSlave>    m_trackSamplesControl;
    QSharedPointer<ControlObjectSlave>m_playControl;
