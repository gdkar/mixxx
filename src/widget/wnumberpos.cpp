...
WNumberPos::WNumberPos(const char* group, QWidget* parent)
        : WNumber(parent),
          ...
          m_bRemain(false) {
    m_pShowTrackTimeRemaining = new ControlObject(ConfigKey("Controls", "ShowDurationRemaining"),this);
    ...
    m_pVisualPlaypos = new ControlObject(ConfigKey(group, "playposition"),this);
    ...
    m_pTrackSamples->connectValueChanged(this, SLOT(slotSetTrackSamples(double)));
