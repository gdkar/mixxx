...
WWidgetStack::WWidgetStack(QWidget* pParent,
        ...
        : QStackedWidget(pParent),
          ...
          m_currentPageControl(pCurrentPageControl ?pCurrentPageControl->getKey() : ConfigKey()) {
...
void WWidgetStack::addWidgetWithControl(QWidget* pWidget, ControlObject* pControl,int on_hide_select) {
    ...
    if (pControl) {
        WidgetStackControlListener* pListener = new WidgetStackControlListener(this, pControl, index);
