...
const CSAMPLE_GAIN CSAMPLE_GAIN_ZERO = CSAMPLE_ZERO;
const CSAMPLE_GAIN CSAMPLE_GAIN_ONE = CSAMPLE_ONE;
const CSAMPLE_GAIN CSAMPLE_GAIN_MIN = CSAMPLE_GAIN_ZERO;
const CSAMPLE_GAIN CSAMPLE_GAIN_MAX = CSAMPLE_GAIN_ONE;
