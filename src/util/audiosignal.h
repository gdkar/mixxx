...
public:
    ...
    static constexpr const SINT kChannelCountMax     = 256; // upper bound (8-bit unsigned integer)
    ...
    static constexpr const SINT kSamplingRate48kHz   = 48000;
    static constexpr const SINT kSamplingRate96kHz   = 96000;
