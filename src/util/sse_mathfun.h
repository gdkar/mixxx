...
#define _PS_CONST(Name, Val)                                            \
  static constexpr ALIGN16_BEG float _ps_##Name[4] ALIGN16_END = { (const float)Val, (const float)Val, (const float)Val, (const float)Val }
#define _PI32_CONST(Name, Val)                                            \
  static constexpr ALIGN16_BEG int _pi32_##Name[4] ALIGN16_END = { (int)Val, (int)Val, (int)Val, (int)Val }
