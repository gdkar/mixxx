...
class DragAndDropHelper {
  public:
    ...
    static QList<QFileInfo> dropEventFiles(const QMimeData& mimeData,
        ...
        auto files = DragAndDropHelper::supportedTracksFromUrls(mimeData.urls(), firstOnly, acceptPlaylists);
        return files;
    }
    ...
    static QUrl urlFromLocation(const QString& trackLocation) {return QUrl::fromLocalFile(trackLocation);}
  private:
