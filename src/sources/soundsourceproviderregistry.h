...
public:
    ...
    void registerProvider(const SoundSourceProviderPointer& pProvider);
    // Registers a provider from a plugin library for all supported
    // file extensions with their cooperative priority hint.
    void registerPluginLibrary(const SoundSourcePluginLibraryPointer& pPluginLibrary);
    ...
    void deregisterProvider(const SoundSourceProviderPointer& pProvider);
    ...
    void deregisterPluginLibrary(const SoundSourcePluginLibraryPointer& pPluginLibrary);
