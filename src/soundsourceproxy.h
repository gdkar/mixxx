...
public:
    ...
    QString getType() const {
        return m_pSoundSource?m_pSoundSource->getType():QString();
    }
    Result parseTrackMetadata(Mixxx::TrackMetadata* pMetadata) const Q_DECL_OVERRIDE {
        return m_pSoundSource?m_pSoundSource->parseTrackMetadata(pMetadata):ERR;
    }
    QImage parseCoverArt() const Q_DECL_OVERRIDE {
